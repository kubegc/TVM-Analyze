...
json_path = os.path.join(program_path,"../create_dataset/datasets_models/dataset.json") 
datas = {}
picture_index = 1
...
device = {"dell04":{"0":"GTX-2080Ti","1":"GTX-2080Ti"},"dell03":{"0":"Tesla-T4"},"dell01":{"0":"Tesla-T4"},"dellh01":{"0":"Tesla-K40c"}}
